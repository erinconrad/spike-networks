function high_gamma_spike(overwrite,time_window,not_a_spike)
...
for whichPt = whichPts
    ...
    out_file = [output_folder,sprintf('%s%shighgamma_allch.mat',name,not_a_spike_text)];
    ...
    ers_array = nan(n_spikes,n_windows,1,nchs);
