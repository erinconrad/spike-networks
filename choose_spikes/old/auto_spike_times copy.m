...
n_skip = 10e3; % skip patient if <10000 spikes 
window_sp = 11; % don't allow spikes closer than 11 seconds apart
window_ns = 6; % Don't allow not-spikes within 6 seconds of spikes
