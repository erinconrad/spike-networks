function make_fig12(stats,windows,met,which_pre_rise)
...
[ha, pos] = tight_subplot(2, n_freq_abs+1, [0.15 0.01], [0.13 0.06], [0.07 0.01]);
...
times = stats(1).time(t).freq(1).ers.pt(1).times;
